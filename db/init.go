...
func checkTables() {
	...
	dbInstance.Exec("CREATE TABLE IF NOT EXISTS `cache_appid_code` (`appid` VARCHAR(128) NOT NULL, `appname` TEXT NOT NULL, `appcode` TEXT NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;")
