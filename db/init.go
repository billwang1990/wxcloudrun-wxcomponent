...
func checkTables() {
	...
	dbInstance.Exec("CREATE TABLE IF NOT EXISTS `cache_appid_code` (`appid` VARCHAR(128) NOT NULL, `appcode` TEXT NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;")
	dbInstance.Exec("CREATE TABLE IF NOT EXISTS `talks_ai_bot` (`botid` VARCHAR(255) NOT NULL, `appid` VARCHAR(255) NOT NULL, `filters` TEXT NULL, `prefix` TEXT NULL, `suffix` TEXT NULL, PRIMARY KEY (`botid`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;`")
