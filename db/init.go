...
func checkTables() {
	...
	dbInstance.Exec("CREATE TABLE IF NOT EXISTS `cache_appid_code` (`appid` VARCHAR(128) NOT NULL, `appname` TEXT NOT NULL, `appcode` TEXT NOT NULL, `verifyinfo` INT NOT NULL DEFAULT -1) ENGINE=InnoDB DEFAULT CHARSET=utf8;")
	dbInstance.Exec("CREATE TABLE IF NOT EXISTS `talks_ai_bot` (`botid` VARCHAR(255) NOT NULL, `appid` VARCHAR(255) NOT NULL UNIQUE, `verified` BOOLEAN, `name` TEXT NOT NULL, `filters` TEXT, `excludefilters` TEXT, `prefix` TEXT, `suffix` TEXT, PRIMARY KEY (`botid`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;")
