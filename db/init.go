...
func checkTables() {
	...
	dbInstance.Exec("CREATE TABLE IF NOT EXISTS `cacheTmpAppidWithCode` (`appid` VARCHAR(64) NOT NULL, `appcode` VARCHAR(64) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;")
