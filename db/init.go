...
func checkTables() {
	...
	dbInstance.Exec("CREATE TABLE IF NOT EXISTS `talks_ai_bot` (`botid` VARCHAR(255) NOT NULL, `appid` VARCHAR(255) NOT NULL, `name` TEXT NOT NULL, `filters` TEXT, `excludefilters` TEXT, `prefix` TEXT, `suffix` TEXT, PRIMARY KEY (`botid`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;")
